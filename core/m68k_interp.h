...
void m68k_jit_move_b_addr_to_addr_mmio(m68k_cpu *cpu); /* M6.228 */
...
void m68k_jit_cmp_w_addr_dn_mmio(m68k_cpu *cpu);        /* M6.241 */
void m68k_jit_move_w_addr_to_postinc_mmio(m68k_cpu *cpu); /* M6.242 */
void m68k_jit_movea_w_addr_to_am_mmio(m68k_cpu *cpu);   /* M6.243 */
